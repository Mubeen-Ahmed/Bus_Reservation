...
<td><a href="oneway.html" class="button"><input type="Reset"/></a></td>
</tr>
...
<th><font color="black" size="4">Bustype</th><th><font color="black" size="4">Timing</th><th><font color="black" size="4">Cost</th><th><font color="black" size="4">Journey Date</th><th>&nbsp;</th>
</tr>
<%
	while(rs.next()){
		out.println("<tr>");
		...
		out.println("<td><a href=book.jsp?not="+passengers+"&doj="+doj+"&from="+from+"&to="+to">BOOK</a></td>");
		out.println("</tr>");
	}
